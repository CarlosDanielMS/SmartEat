...
class SelectedAllergen extends Model
{
    /*
    ...
    */
    public function add($user_id, $allergen_id)
    {
        $sql = "INSERT INTO selected_allergens (user_id, allergen_id) VALUES (:user_id, :allergen_id)";
        $sql = $this->db->prepare($sql);
        $sql->bindValue(":user_id", $user_id);
        $sql->bindValue(":allergen_id", $allergen_id);
        $sql->execute();
