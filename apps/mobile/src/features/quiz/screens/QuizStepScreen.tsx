// src/features/quiz/screens/QuizStepScreen.js
...
const ListItem = ({ item }) => {
  ...
  return (
    <View style={styles.listItem}>
      ...
      <Text style={[styles.listText, styleType, styles.listItemText]}>
        {item.text}
      </Text>
    </View>
  );
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          ...
          {stepData.title2 && (
            <Text style={styles.title2}>{stepData.title2}</Text>
          )}
          ...
          {stepData.legal && (
            <Text style={styles.legal}>{stepData.legal}</Text>
          )}
