...
export default function EditAllergenScreen({ route, navigation }) {
  ...
  const handleUpdate = () => {
    ...
    navigation.navigate('ManageAllergens', { updatedItem: updatedItem });
  };

  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <Text style={styles.label}>Editar Nome do Grupo</Text>
        <TextInput
          style={styles.input}
          value={name}
